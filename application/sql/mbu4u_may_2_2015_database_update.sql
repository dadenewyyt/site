...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `hunt`()
begin
...
(1, 'Saving', 'Danny', '123123', NULL, 1, 'Nevda');
...
('6a95b095a90da5ab149e757158655dea', '::1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36', 1430557002, '');
...
(1, NULL, NULL, 'store_image74804.jpg', 'C:/webserver_xamp/htdocs/madebyus4u/uploads/profile/1/store/', 'store_image', 1, 1, NULL),
(2, NULL, NULL, 'product_image91384.png', 'C:/webserver_xamp/htdocs/madebyus4u/uploads/profile/1/products/', 'product_image', 1, 1, 1),
(3, NULL, NULL, 'profile_image31091.png', 'C:/webserver_xamp/htdocs/madebyus4u/uploads/profile/1/avatar/', 'profile_image', 1, NULL, NULL);
...
INSERT INTO `products` (`id`, `name`, `desc`, `price`, `rate_id`, `category`, `shipping`, `variation`, `sub_variation`, `profile_id`, `sprice`, `quantity`, `store_id`, `product_details`) VALUES
(1, 'asdasd', 'asdasd', '23', NULL, '1', NULL, '#', '#', 1, '23.00', 23, 1, 'asdasda');
...
(1, 'Dan', 'add', NULL, '78989', 'Vegas', 'Nevada', 'This is a test info', b'1', 'Software Engineer', 'YYT Software', NULL, 2, b'1', 3, NULL, NULL, 'http://www.madebyus4u.com', NULL, NULL, NULL, NULL);
...
INSERT INTO `stores` (`id`, `store_name`, `desc`, `owner_profile_id`, `is_launched`, `is_paid`, `media_id`) VALUES
(1, 'store 2', 'ssdf', 1, b'1', b'1', 1);
...
(2, '::1', 'dadenew', '$2y$08$EG39kjVkxiwa3GgJSUTCeeWDOhWhGRVhZztWEi/O8ozlpTTavQq2O', NULL, 'dadenewyyt@gmail.com', '87d5de28b6b2a20daeaa1d2b47d6d069899d6a11', NULL, NULL, NULL, 1430133217, 1430551631, 1, NULL, NULL, NULL, NULL, 1);
...
ALTER TABLE `products`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_product_profile_id` (`profile_id`), ADD KEY `fk_product_store_id` (`store_id`);
...
--
ALTER TABLE `stores`
 ADD PRIMARY KEY (`id`), ADD KEY `fk_profile_store_id` (`owner_profile_id`), ADD KEY `fk_store_media_id` (`media_id`);
...
ADD CONSTRAINT `fk_product_store_id` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ADD CONSTRAINT `fk_store_media_id` FOREIGN KEY (`media_id`) REFERENCES `medias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
